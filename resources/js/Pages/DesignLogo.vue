<template>
    <div
        class="w-72 aspect-square border-2 bg-white text-center p-16"
    >
        <svg
            class="inline-block text-slate-400 h-24 w-24"
            viewBox="0 0 512 512"
        ><path
            fill="currentColor"
        ...
        /></svg>
        <p
            class="-mt-14 text-5xl font-pattaya tracking-tight text-slate-900 transform -rotate-12"
        >
            ทาบไทม์
        </p>
        <p class="mt-6 font-semibold text-slate-600">
            ทดสอบ
        </p>
    </div>
</template>
